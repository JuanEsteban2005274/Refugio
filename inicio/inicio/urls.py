...
from sesion.views import actualizar_estado_cita, admin_dashboard, gestionar_perfil, login, nuevos_usuarios, registrar,pagina_de_inicio, base, citas, donaciones, admin_citas, crear_mascota, forgotten, RestablecerContraseña, error, redic, si, mis_citas, eliminar_masc, modificar, crud
from administra.views import mas
...
urlpatterns = [
    ...
    path('eliminar/<int:id>/', eliminar_masc, name='eliminar'),
