...
from .forms import PerfilForm, RegistrarseForm, InicioSesionForm, MascotaForm, CitaForm
...
def nuevos_usuarios(request):
    ...
    for user in admin_users:
        user.is_online = user.last_login and user.last_login > status_threshold
    for user in normal_users:
        user.is_online = user.last_login and user.last_login > status_threshold
    return render(request, 'nuevos_usuarios.html', {'admin_users': admin_users, 'normal_users': normal_users})
...
def actualizar_estado_cita(request, cita_id):
    ...
    return render(request, 'admin_citas.html')